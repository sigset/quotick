...
use super::{SubTrie, SubTrieMut, Trie, TrieCommon, TrieKey};
        ...
        K: TrieKey,
{
    ...
    /// form *must* match those for the key type.
    #[inline]
    pub fn subtrie<Q: ?Sized>(&self, key: &Q) -> Option<SubTrie<K, V>>
        where
            K: Borrow<Q>,
            Q: TrieKey,
    {
    ...
    /// form *must* match those for the key type.
    #[inline]
    pub fn subtrie_mut<Q: ?Sized>(&mut self, key: &Q) -> Option<SubTrieMut<K, V>>
        where
            K: Borrow<Q>,
            Q: TrieKey,
    {
    ...
    /// form *must* match those for the key type.
    #[inline]
    pub fn get_ancestor<Q: ?Sized>(&self, key: &Q) -> Option<SubTrie<K, V>>
        where
            K: Borrow<Q>,
            Q: TrieKey,
    {
    ...
    /// form *must* match those for the key type
    #[inline]
    pub fn get_raw_ancestor<Q: ?Sized>(&self, key: &Q) -> SubTrie<K, V>
        where
            K: Borrow<Q>,
            Q: TrieKey,
    {
    ...
    /// form *must* match those for the key type
    #[inline]
    pub fn get_raw_descendant<Q: ?Sized>(&self, key: &Q) -> Option<SubTrie<K, V>>
        where
            K: Borrow<Q>,
            Q: TrieKey,
    {
